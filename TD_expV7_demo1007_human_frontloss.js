...
function logotestintroRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of logotestintroComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function logotest_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of logotest_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function logotest_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of logotest_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PHASE2intro_roleRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PHASE2intro_roleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ph2matchRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ph2matchComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ph2v2test_codeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ph2v2test_codeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ph2v2testpreRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ph2v2testpreComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function time_down_numRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of time_down_numComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ph2v2testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ph2v2testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ph2v2test_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ph2v2test_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ph2scaleintroRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ph2scaleintroComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ph2scalesRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ph2scalesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PHASE3instrRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PHASE3instrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PHASE3instr_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PHASE3instr_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PHASE3intr_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PHASE3intr_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ph3_prequestionRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ph3_prequestionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ph3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ph3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
